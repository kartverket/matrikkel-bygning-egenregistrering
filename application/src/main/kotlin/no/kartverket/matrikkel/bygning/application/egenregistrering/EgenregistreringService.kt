...
class EgenregistreringService(
    ...
    fun addEgenregistrering(egenregistrering: Egenregistrering): Result<Unit, DomainError> {
        return bygningClient
            ...
            .andThen { EgenregistreringValidator.validateEgenregistrering(egenregistrering, it) }
            .onSuccess { egenregistreringRepository.saveEgenregistrering(egenregistrering) }
    }
