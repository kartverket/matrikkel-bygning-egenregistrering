...
fun Route.arkivRouting(bygningService: BygningService) {
    route("bygninger") {
        route("{bygningId}") {
                ...
                get(
                    {
                        ...
                        request {
                            ...
                            queryParameter<Instant>("registreringstidspunkt") {
                                description =
                                    "Tidspunktet du ønsker å hente data basert på. Format: ISO-8601. Default: nåtidspunkt"
                            }
                        }
                        response {
