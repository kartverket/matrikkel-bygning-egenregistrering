    ...
    return BruksenhetRegistrering(
        ...
        bruksarealRegistrering = bruksarealRegistrering?.let {
            BruksarealRegistrering(
                ...
                etasjeRegistreringer = it.etasjeRegistreringer?.map { etasjeBruksarealRegistreringRequest ->
                    etasjeBruksarealRegistreringRequest.toEtasjeBruksarealRegistrering()
                },
            )
        },
