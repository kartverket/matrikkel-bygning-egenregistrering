...
sealed interface Felt<T> {
    ...
    sealed class EnergikildeOpplysning {
        ...
        data class HarIkke private constructor(
            val metadata: RegisterMetadata,
        ) : EnergikildeOpplysning() {
            companion object {
                fun of(metadata: RegisterMetadata) = HarIkke(metadata)
            }

            override fun toEnergikilder(): List<Energikilde> =
                listOf(
                    Energikilde(
    ...
    sealed class OppvarmingOpplysning {
        ...
        data class HarIkke private constructor(
            val metadata: RegisterMetadata,
        ) : OppvarmingOpplysning() {
            companion object {
                fun of(metadata: RegisterMetadata) = HarIkke(metadata)
            }

            override fun toOppvarming(): List<Oppvarming> =
                listOf(
                    Oppvarming(
