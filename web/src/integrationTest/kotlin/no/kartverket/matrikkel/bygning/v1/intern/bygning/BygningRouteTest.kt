...
class BygningRouteTest : TestApplicationWithDb() {
    @Test
    fun `gitt at en bygning id eksisterer svarer bygning route ok`() =
        testApplication {
    ...
    @Test
    fun `gitt at en bygning id ikke eksisterer svarer bygning route not found`() =
        testApplication {
            val client = mainModuleWithDatabaseEnvironmentAndClient()
    ...
    @Test
    fun `gitt at en bygning eksisterer uten egenregistrert data skal alle feltene vaere null`() =
        testApplication {
            val client = mainModuleWithDatabaseEnvironmentAndClient()
    ...
    @Test
    fun `gitt at en bygning eksisterer med noe egenregistrert data feltene vaere satt`() =
        testApplication {
            val client = mainModuleWithDatabaseEnvironmentAndClient()
