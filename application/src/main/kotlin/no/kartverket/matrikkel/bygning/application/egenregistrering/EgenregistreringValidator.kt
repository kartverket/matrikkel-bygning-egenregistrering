...
class EgenregistreringValidator {
    companion object {
        ...
        private fun oppvarmingHasDuplicates(oppvarmingRegistrering: OppvarmingRegistrering?) =
        ...
        private fun energikildeHasDuplicates(energikildeRegistrering: EnergikildeRegistrering?) =
