...
class MatrikkelAuthService(
    private val matrikkelApiProvider: MatrikkelApi,
) : AuthService {
    /**
    ...
    override suspend fun harMatrikkeltilgang(
        ...
        return withContext(Dispatchers.IO) {
            ...
            brukerId?.let {
                ...
                val harAkseptabelRettighet =
                    brukerrettighetliste.rettigheter.item
