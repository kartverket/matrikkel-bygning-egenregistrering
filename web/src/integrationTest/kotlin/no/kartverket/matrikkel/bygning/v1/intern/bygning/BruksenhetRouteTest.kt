...
class BruksenhetRouteTest : TestApplicationWithDb() {
    ...
    @Test
    fun `gitt at energikilde blir registrert med har ikke, returneres dette som eneste element i listen`() =
        testApplication {
            val client = mainModuleWithDatabaseEnvironmentAndClient()
            val token = mockOAuthServer.issueIDPortenJWT()
    ...
    @Test
    fun `gitt at oppvarming blir registrert med har ikke, returneres dette som eneste element i listen`() =
        testApplication {
            val client = mainModuleWithDatabaseEnvironmentAndClient()
            val token = mockOAuthServer.issueIDPortenJWT()
