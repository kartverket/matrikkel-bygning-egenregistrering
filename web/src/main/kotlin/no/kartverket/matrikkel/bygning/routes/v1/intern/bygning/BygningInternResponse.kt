...
private fun EnergikildeOpplysning.toEnergikildeResponse() =
    this.toEnergikilder().map {
        EnergikildeInternResponse(
            data = it.data,
...
private fun OppvarmingOpplysning.toOppvarmingResponse() =
    this.toOppvarming().map {
        OppvarmingInternResponse(
            data = it.data,
            metadata = it.metadata.toRegisterMetadataInternResponse(),
        )
