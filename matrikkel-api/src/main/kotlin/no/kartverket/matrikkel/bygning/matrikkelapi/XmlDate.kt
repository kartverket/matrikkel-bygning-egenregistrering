...
import no.statkart.matrikkel.matrikkelapi.wsapi.v1.domain.Timestamp as MatrikkelTimstamp

fun MatrikkelTimstamp.toInstant(): Instant {
    val calendar = timestamp.toGregorianCalendar() // TODO: Må sjekke litt mer på hvor trygt dette er
    return calendar.toInstant()
}

fun MatrikkelLocalDate.toJavaLocalDate(): LocalDate {
    return LocalDate.of(
        date.year,
        date.month,
        date.day
